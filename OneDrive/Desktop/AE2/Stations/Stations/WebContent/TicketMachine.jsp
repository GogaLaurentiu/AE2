      ...
      <img src="ticket.jpg" alt="Ticket COunter" style="width:569px;height:426px;">
					    ...
					    <div class="col-sm">
					     <form action="destination" method="post">
					      <input type="text" value="This Station : ${name}" name="currentStation" disabled="true" style="width: 50%">
					     <br>
					      <select name="stationName" class="browser-default custom-select" style="width: 50%">
