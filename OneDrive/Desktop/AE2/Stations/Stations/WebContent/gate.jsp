      ...
      <img src="gate.jpg" alt="Ticket COunter" style="width:569px;height:426px;">
					    ...
					    <div class="col-sm">
					     <form action="validate" method="post">
					      ...
					      <select name="options" class="browser-default custom-select" style="width: 50%" required="true">
						  <option selected>SELECT YOUR GATE STATION</option>
						   <c:forEach items="${stationName}" var="options" varStatus="loop">
							...
							<br>
							<input type="text" value="Serect KEY" name="key" style="width: 50%" required="true">
							<br>
